...
public class PickFriendsActivity extends FragmentActivity {
	...
	public static void populateParameters(Intent intent, String userId, boolean multiSelect,
		...
		intent.putExtra(PickerFragment.SHOW_TITLE_BAR_BUNDLE_KEY, showTitleBar);
	}
	...
	private void onError(Exception error) {
		...
		new AlertDialog.Builder(this).setTitle(R.string.error_dialog_title).setMessage(error.getMessage())
